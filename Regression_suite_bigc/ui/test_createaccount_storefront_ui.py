...
def test_createaccount_storefront(browser, url, email, password):
    ...
    browser.find_element_by_xpath('//a[text() = "Create an account"]').click()
    ...
    account.select_dropdown_value(browser, 'FormField_11', 'Australia')
    account.select_dropdown_value(browser, 'FormField_12', 'New South Wales')
