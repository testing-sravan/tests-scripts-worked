...
class ProductClass(CommonMethods):
    ...
    def add_image(self, browser, productname):
        ...
        self.wait_until_element_present("gallery-image-192", "ID")
        browser.find_element_by_id('gallery-image-192').click()
    ...
    def delete_product_option(self, browser, name):
        ...
        browser.find_element_by_xpath("//td[contains(.,'" + name + "')]/preceding-sibling::td/descendant::label").click()
